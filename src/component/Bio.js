      ...
      <div className="grid grid-cols-1 md:grid-cols-3">
        <div className="bio">
          <div className="biography">
            ...
            <p className="w-[300px] text-2xl pb-10">
              Work for money and web development for love, I'm Hasan, an
          ...
          <div className="biography">
            ...
            <p className="w-[300px] text-2xl pb-10">
              Dhaka, Bangladesh <br /> hasan.md.east@gmail.com <br /> +880
              1688861610
            </p>
          </div>
          <div className="biography">
            ...
            <p className="w-[300px] text-2xl pb-10">
              Full-stack web development <br /> Web application development
              <br />
        ...
        <div className="project text-right">
          <div className="biography">
            <h2 className="small-heading my-10 uppercase">
          ...
          <div className="biography">
            <h2 className="small-heading my-10 uppercase">
              Linkedin skill <br /> assessment passed
            </h2>
